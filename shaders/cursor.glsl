...
/* Violet‑compatible palette */
const vec4 TRAIL_COLOR            = vec4(0.4, 0.2, 0.6, 1.0);  // Deep purple
const vec4 CURRENT_CURSOR_COLOR   = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR  = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT     = vec4(0.6, 0.4, 0.8, 1.0);  // Brighter purple
const vec4 TRAIL_COLOR_GLOW       = vec4(0.3, 0.1, 0.5, 1.0);  // Dark purple glow
const float DURATION = 0.5;
const float OPACITY = 0.6;                                        // Higher opacity for dramatic effect
